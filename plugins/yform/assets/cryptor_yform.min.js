...
if(!a)a:{if(a=$(".rex-page-section form:first").attr("action")){a=a.split("&");for(var c=0;c<a.length;c++){var b=a[c].split("=");if("table_name"===b[0]){a=b[1];break a}}}a=null}return a},r=function(a){a=a.find(".form-control");return"text"===a.prop("type")?a:"email"===a.prop("type")?(a.prop("type","text"),a):"textarea"===a.prop("tagName").toLowerCase()?a:null},q=function(a){var c=a.find("span");if(!c.length){var b=a.html();a.wrapInner("<span></span>");c=a.find("span");c.attr("title",b)}return c.addClass("cryptor-yform-list-value-wrapper")};
